cask 'alfred2' do
  ...
  zap delete: [
                ...
                '~/Library/Preferences/com.runningwithcrayons.Alfred-Preferences-2.plist',
                '~/Library/Saved Application State/com.runningwithcrayons.Alfred-Preferences-2.savedState',
              ]
end